class Users::InvitationsController < Devise::InvitationsController
  ...
  def user_params
    params.require(:user).permit(:password, :password_confirmation, :secret_code, :invitation_token, :terms_of_service, :enable_validation)
  end
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.for(:accept_invitation).concat [:secret_code, :terms_of_service]
    # Override accepted parameters
    devise_parameter_sanitizer.for(:accept_invitation) do |u|
      u.permit(:password, :password_confirmation, :secret_code,
